...
playerX, playerY, playerXVel, playerYVel = 400, 750, 0, 0
timer = 0
...
bullet = Bullet(playerX+28, playerY)
...
while not GameOver:
    ...
    if bullet.Alive == True:
        bullet.move(playerX + 28, playerY)
        if bullet.Alive == True:
    ...
    bullet.draw()
    pygame.draw.rect(screen, (0,200,100), (playerX, 750, 60, 20))
    pygame.draw.rect(screen, (0,200,100), (playerX + 5, 745, 50, 20))
    pygame.draw.rect(screen, (0,200,100), (playerX + 20, 735, 20, 20))
    pygame.draw.rect(screen, (0,200,100), (playerX + 25, 730, 10, 20))
